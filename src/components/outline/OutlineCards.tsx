            ...
            <div className="flex justify-between items-start mb-3">
              ...
              <div className="flex items-center gap-2">
                <Link 
                  ...
                  className="hidden md:flex items-center gap-1.5 text-xs text-[var(--text-muted)] hover:text-[var(--accent-primary)] font-medium p-1 transition-colors"
                  title="閱讀完整指南"
                >
                ...
                <button 
                  ...
                  className="p-1.5 text-[var(--text-muted)] hover:bg-[var(--surface-soft)] rounded-md transition-colors xl:hidden"
